...
But, they are laid out in a way that is precise and unambiguous, which gives rise to the complex nature of the
...
<p align="justify">
Lets have a look at one of these complex clauses in detail and see how we we can 
convert them into a machine readable format.</p> <br>
...
the Governors - "Consolidated Total Assets" and "Consolidated Adjusted EBIDTA" and the Objects - "$100,000,000", 
...
tagger which models all the above elements together. We can use language models which are pretrained on public 
legal text or we can pre-train a language model specifically on Credit agreements from scratch to further improve the accuracy of
...
is to quickly build a baseline solution and iterate upon it. This helps us to benchmark the improvements which the advanced 
...
interdependencies between them. Objects belong to the Operators and Operators need to be 
...
do a powerful semantic search over multiple Credit Agreements. Some interesting queries could be - Show me all 
